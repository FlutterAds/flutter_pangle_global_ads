...
/** FlutterGromoreAdsPlugin */
public class FlutterPangleGlobalAdsPlugin implements FlutterPlugin, ActivityAware {
  // 方法通道
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    // 初始化方法通道和事件通道
    methodChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_pangle_global_ads");
    eventChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_pangle_global_ads_event");
  }
